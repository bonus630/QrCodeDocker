...
namespace br.corp.bonus630.plugin.ShapeToCode.Lang
{
    ...
    {
        public string BTN_ProcessDoc { get { return "Process Document"; } }

        public string BTN_ProcessPage { get { return "Process Page"; } }

        public string BTN_ProcessSelection { get { return "Process Selection"; } }
